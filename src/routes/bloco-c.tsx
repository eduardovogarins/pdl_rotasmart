...
import { BlocoCFTV } from "@/components/auditoria/BlocoCFTV";
import { ArrowLeft, Save, ChevronRight } from "lucide-react";
import { Button } from "@/components/ui/button";

export const Route = createFileRoute("/bloco-c")({
  component: BlocoCPage,
});
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            A pontuação deste pilar inicia em 100 e decai para cada divergência grave ou infraestrutura degradada apontada in-loco pela equipe.
          </p>
        </div>
